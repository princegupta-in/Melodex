            ...
            <main className="min-h-screen bg-gradient-to-br pt-10 flex flex-col items-center justify-center p-4 relative overflow-hidden">
                <div className="w-full max-w-full mt-8 mb-4 text-center bg-black/10 backdrop-blur-sm p-4 rounded-lg flex flex-col items-center py-10 sm:p-6">
                    ...
                    {(!session.data?.user || (session.data?.user && !isCreator)) && (
                        <form onSubmit={handleJoinRoom} className="flex flex-col sm:flex-row items-stretch w-full mt-4 justify-center">
                            ...
                            <input
                                type="text"
                                className="border border-gray-300 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-500 w-full sm:w-64 rounded-none sm:rounded-r-none sm:rounded-l-none"
